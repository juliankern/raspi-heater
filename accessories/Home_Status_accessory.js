...
var accessory = exports.accessory = new Accessory('Home Status', uuid.generate('hap-nodejs:accessories:Outlet'));

accessory.username = "1A:2B:3C:4D:5D:FF";
...
// yep, this "accessory" is always in use. no idea why this is a requirement
accessory
    .getService(Service.Outlet)
